...
const SECOES: SecaoAjuda[] = [
  {
    ...
    items: [
      ...
      { comando: 'PORT', descricao: 'Carteira e P&L (Portfolio)', atalho: 'Ctrl+P' },
      { comando: 'DEFI', descricao: 'DeFi / On-Chain Tracker (DefiLlama)', atalho: 'Ctrl+D' },
      { comando: 'ALERT', descricao: 'Sentinela IA — Alertas & Triggers', atalho: 'Ctrl+A' },
      { comando: 'BOND', descricao: 'Bond Calculator (Duration/DV01)', atalho: '' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { comando: '<TICKER> <Clase> DES', descricao: 'Análise IA com Bond (Description)' },
  ...
  },
  {
    ...
    items: [
      ...
      { comando: 'Ctrl+P', descricao: 'Portfolio & P&L' },
      { comando: 'Ctrl+D', descricao: 'DeFi / On-Chain Tracker' },
      { comando: 'Ctrl+A', descricao: 'Sentinela IA — Alertas' },
    ...
    <div className="h-full overflow-y-auto bg-[#0A0A0A] p-6 font-mono">
      ...
      <div className="mb-8">
        ...
        <div className="text-neutral-400 text-xs mt-1">
          v2.0.0 · Agente Bond via Ollama · React 19 · Next.js 15
        </div>
      </div>
