...
export function MarketOverviewPanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0A0A0A] overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 grid grid-cols-[2fr_2fr_1fr_1fr_1fr_48px] gap-2 items-center px-4 py-2 text-right bg-neutral-950 border-b border-neutral-800 font-mono text-[10px] text-neutral-600">
      ...
      {GRUPOS_MERCADO.map((grupo) => (
        <div key={grupo.regiao}>
          <div
            className="px-4 py-1 font-mono text-[10px] font-bold border-b border-neutral-800"
